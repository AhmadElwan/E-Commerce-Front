    ...
    <div className='border-t-1 border-gray-600 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='mt-20'>
        ...
        <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500'>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quibusdam, autem. Doloribus, consequatur. Quisquam, quae. Quibusdam, autem. Doloribus, consequatur. Quisquam, quae. Quibusdam, autem. Doloribus, consequatur. Quisquam, quae.</p>
          <p>E-commerce websites are a type of website that specializes in selling products or services online. They are a great way to reach a wide audience and increase sales.</p>
        </div>
      </div>
